        ...
        <>
            ...
            <div className='aval-credit-total-transaction'>
                <div className='aval-credit'>
                    <Card text="13,750.00 NGL" header="AVAILABLE CREDIT" icon={[<svg key={Math.random()} xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-wallet2 wallet" viewBox="0 0 16 16">
                        <path d="M12.136.326A1.5 1.5 0 0 1 14 1.78V3h.5A1.5 1.5 0 0 1 16 4.5v9a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 13.5v-9a1.5 1.5 0 0 1 1.432-1.499L12.136.326zM5.562 3H13V1.78a.5.5 0 0 0-.621-.484L5.562 3zM1.5 4a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5h-13z" />
                    </svg>]} />
                </div>

                <div className='total-transaction'>
                    <Card text="1,133,750.00 NGL" header="TOTAL TRANSACTIONS" icon={[<svg key="clock" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-clock-history" viewBox="0 0 16 16">
